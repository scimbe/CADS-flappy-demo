...
#
# art is force-excluded (LLM_SHIM_DISABLED_ROLES): live use surfaced a real quality gap on
# niche/knowledge-heavy prompts the pre-rollout A/B harness never covered (e.g. "freebsd
